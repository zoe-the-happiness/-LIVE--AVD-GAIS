  ...
  return (
    <div className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-6">Units</h1>
        <p className="text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
          AVD maintains a strong presence across all units in West Bengal. Find your local representative and unit-level activities here.
        </p>
