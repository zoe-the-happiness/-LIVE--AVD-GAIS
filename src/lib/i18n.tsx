...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "membership.fee_subtitle": "Below are the official contribution guidelines and renewal rates for different member categories.",
    ...
    "membership.val.inservice": "In-Service Veterinary Doctors",
    "membership.val.retired": "Retired / MVC / MVU Members",
    "membership.val.graduates": "Veterinary Graduates awaiting Employment",
  ...
  bn: {
    ...
    "membership.fee_subtitle": "বিভিন্ন শ্রেণীর সদস্যদের জন্য অফিশিয়াল অবদান নির্দেশিকা এবং নবায়ন ফি-এর তালিকা নীচে দেওয়া হল।",
    ...
    "membership.val.retired": "অবসরপ্রাপ্ত / এমভিসি / এমভিউ সদস্য",
